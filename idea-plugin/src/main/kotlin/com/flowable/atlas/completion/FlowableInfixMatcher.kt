 ...
 * mid-key fragment like `0061` matches the model key `DEMO-DO-0061` (or `DO-0061`, or a name word).
 *
 * Flowable keys are structured, not camelCase (`DEMO-DO-0061`, `DEMO_P001`), so the platform's
