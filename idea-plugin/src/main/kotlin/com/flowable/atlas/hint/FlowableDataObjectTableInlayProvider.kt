 ...
 * Settings → Editor → Inlay Hints → Values → "Data object table names" — the IDE's page is the one switch — the hover/Ctrl-Q
    ...
    private class Collector(private val tables: Map<String, String>) : SharedBypassCollector {
        override fun collectFromElement(element: PsiElement, sink: InlayTreeSink) {
            ...
            sink.addPresentation(
                ...
                // Same boxed inlay as before; the `hasBackground` overload is deprecated in favour of
                // passing the HintFormat (see FlowableActionNameInlayProvider).
