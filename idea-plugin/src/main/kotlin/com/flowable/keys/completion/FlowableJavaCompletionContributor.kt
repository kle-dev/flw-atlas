...
import com.flowable.keys.index.ModelEntry
...
class FlowableJavaCompletionContributor : CompletionContributor() {
    ...
    private class Provider : CompletionProvider<CompletionParameters>() {
        ...
        override fun addCompletions(
            ...
            // Infix matching: typing "0061" matches "DEMO-DO-0061" (a mid-key fragment), not just a prefix.
...
private val FLOWABLE_KEY_MARKER: Key<Boolean> = Key.create("com.flowable.keys.completion.flowableKeyItem")
