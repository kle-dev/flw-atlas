...
class DataObjectBeanGeneratorTest {
    ...
    @Test fun generates_typed_pojo_with_getters_and_setters() {
        val src = DataObjectBeanGenerator.generate(
            "com.acme", "ShoppingList", "DEMO-D010",
        ...
        assertTrue("DEMO-D010 documented: $src", src.contains("DEMO-D010"))
    ...
    @Test fun classNameFor_builds_pascal_case() {
        assertEquals("ShoppingList", DataObjectBeanGenerator.classNameFor("Shopping List", "DEMO-D010"))
        assertEquals("DEMOD010", DataObjectBeanGenerator.classNameFor(null, "DEMO-D010"))
