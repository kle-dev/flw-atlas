...
import com.flowable.keys.inspection.FlowableXmlBrokenKeyInspection
import com.intellij.psi.PsiFile
import com.intellij.testFramework.fixtures.BasePlatformTestCase

/**
 * Tests for the v3 improvements:
 *  - infix key completion (`0061` → `DEMO-DO-0061`),
...
class FlowableInfixAndXmlTest : BasePlatformTestCase() {
    ...
    fun testInfixFragmentCompletesFullKey() {
        ...
        myFixture.addFileToProject("models/DEMO-DO-0061.data", """{"key":"DEMO-DO-0061","name":"DEMO data object"}""")
        myFixture.addFileToProject("models/DEMO-DO-0099.data", """{"key":"DEMO-DO-0099","name":"Other"}""")
        ...
        if (strings == null) {
            assertTrue("expected DEMO-DO-0061 auto-inserted", myFixture.file.text.contains("\"DEMO-DO-0061\""))
        } else {
            assertTrue("expected DEMO-DO-0061 among $strings", strings.contains("DEMO-DO-0061"))
        }
    }
