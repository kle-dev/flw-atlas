...
2. Select `flowable-keys-0.1.0.zip`
3. **Restart**
...
- Version: **0.1.0**
- SHA-256: `a0ae65b2a39eb5a14f078ca5a413c2f69ea83782f1ccb946551f94960fbe6b1e`
...
cd ..                       # into idea-plugin/
./gradlew buildPlugin
cp build/distributions/flowable-keys-0.1.0.zip dist/
# then commit dist/flowable-keys-0.1.0.zip
```
