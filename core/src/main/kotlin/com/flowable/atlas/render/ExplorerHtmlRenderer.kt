...
object ExplorerHtmlRenderer {
    ...
    private val FRONTEND_DATA_KEYS = setOf(
        ...
        "hitPolicy",
        "http", "initiatorVariableName", "inputs", "interfaces", "ioParameters", "ioParams", "kind",
        ...
        "referencedLiquibaseModelKey", "roles", "route", "ruleCount", "ruleTasks", "schemaCoverage",
        "scopes",
        "scopeType", "scriptTasks", "sentries", "service", "serviceTableName", "serviceTasks",
        "signalName", "signature", "sourceId",
        "sourceIndex", "sources", "subProcesses", "tableName", "tables", "temperature", "tools", "topics",
